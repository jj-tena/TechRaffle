defmodule Techraffle.Raffles do
  ...
  def subscribe(raffle_id) do
    Phoenix.PubSub.subscribe(Techraffle.PubSub, "raffle:#{raffle_id}")
  end

  def broadcast(raffle_id, message) do
    Phoenix.PubSub.broadcast(Techraffle.PubSub, "raffle:#{raffle_id}", message)
  end
